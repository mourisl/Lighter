...
Thirdly, we show that the number of positions that contain error and are falsely set as trusted position does not increase. The $x$ kmers from this position are true weak kmers. The null hypothesis stays almost the same again. I will use $\gamma''_1$ to represent the expected multiplicity of true weak kmers in scenario 1 and $\gamma''_2$ for scenario 2. Because in practice the multiplicity of true weak kmers increases sublinearly as the coverage increase, $\gamma''_2 \leq z\gamma''_1$

\begin{equation*}
\begin{aligned}
P^*(\alpha_1, \gamma') - P^*(\alpha_1, \gamma''_1)&=(1-\beta)(P(\alpha_1, \gamma') - P(\alpha_1, \gamma''_1))\approx (1-\beta)(\gamma'\alpha_1 - \gamma''_1\alpha_1)\\
&\leq (1-\beta)(z\gamma'-\gamma''_2)\alpha_2) \approx (1-\beta)(P(\alpha_2, z\gamma')-P(\alpha_2, \gamma''_2)) \\
&=P^*(\alpha_2, z\gamma') - P^*(\alpha_2, \gamma''_2)
\end{aligned}
\end{equation*}

Therefore, the difference of the expected value between the binomial distribution of the null hypothesis and the binomial distribution for the true weak kmers increases. So the probability of such position falsely be classified as trusted does not increase. Though in scenario 2, the number of such position is roughly $z$ times as large as scenario 1, the difference between the expected values increases so fast, as a result even the number of falsely being classfieid as trusted should not increase. 
...
Recall	& musket	& 92.61	& 92.04	& 92.60	& 92.05	& 92.60	& 92.03 \\ \cline{2-8}
	...
	& lighter	& \textbf{99.40}	& \textbf{99.40}	& \textbf{99.40}	& \textbf{99.40} & \textbf{99.40}	& \textbf{99.40} \\ \hhline{|=|=|=|=|=|=|=|=|}
...
F-score	& musket	& 96.06	& 95.68	& 96.05	& 95.69	& 96.05	& 95.68 \\ \cline{2-8}
	...
	& lighter	& \textbf{99.26}	& \textbf{98.56}	& \textbf{99.21}	& \textbf{98.94}	& \textbf{99.22}	& \textbf{99.02} \\ \hhline{|=|=|=|=|=|=|=|=|}
...
Gain	& musket	& 92.40	& 91.70	& 92.39	& 91.71	& 92.39	& 91.69 \\ \cline{2-8}
	...
	& lighter	& \textbf{98.51}	& \textbf{97.15}	& \textbf{98.42}	& \textbf{97.89}	& \textbf{98.44}	& \textbf{98.05} \\ \hhline{|=|=|=|=|=|=|=|=|}
