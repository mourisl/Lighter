...
% Result of SOAPDenovo2
We also tested the affect to the contigs size for SOAPDeovo2 shown in Table \ref{table:chr14_sd2}. In this data set, the improvement due to error corrections is obviously. 
