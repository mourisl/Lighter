...
For the three data sets with different coverage, we can show Lighter can achieve near constant space usage if the portion of set bits, namely occupancy rate, in the bloom filters stays almost the same. And this is true as shown in Table \ref{table:bloom_occupancy_coverage}.
...
This explanation can also be verified by looking at the occupancy rate of table A and B when changing $\alpha$ shown in Figure \ref{fig:bloom_occupancy_alpha}.
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.5\textwidth]{bloom_occupancy_alpha.png}
\caption{The effect of $\alpha$\label{fig:bloom_occupancy_alpha}}
\end{center}
\end{figure}
